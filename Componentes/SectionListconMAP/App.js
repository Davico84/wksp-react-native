...
import { SectionList, Text, Image ,StyleSheet,View} from 'react-native';
...
const SectionListBasics = () => {
  ...
  // console.log("Aquie esta el valor de ID", videogames)
return (
  <>
        <View>
           <Text></Text>
        ...
        <SectionList style={styles.container}
          ...
          renderSectionHeader={({section}) => <Text>{section.title}</Text>}//aqui puedo cambiar la cabecera de grupo
